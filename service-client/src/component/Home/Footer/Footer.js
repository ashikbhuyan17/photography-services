        ...
        <section className='footer'>
            <div className="container">
                <div className="row">
                        ...
                        <div className="footer-first-part mt-5">
                            <div className=" item mt-5">
                                ...
                                <div className="home-town">
                                    ...
                                    <p> <span className=''><FontAwesomeIcon icon={faLocationArrow} /></span>    H00(0thFlor),Road Mirpur 10</p>
                    ...
                    <p className="text-center text-white">All rights are reserve by {(new Date().getFullYear())} <Link>Riaz</Link></p>
